...
- Semantic Scholar key request and usage: [docs/api-keys.md](docs/api-keys.md#semantic-scholar-api-key)
- Paperclip install, login, and API-key setup: [docs/api-keys.md](docs/api-keys.md#paperclip-setup)
